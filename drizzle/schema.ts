...
export const offices = mysqlTable("offices", {
  ...
  notes: text("notes"),
  // ── جديد: قيود وإعدادات المكتب ──
  allowedCurrencies: text("allowed_currencies"),                   // JSON array e.g. ["USD","SDG"], null = all allowed
  dailyLimit: decimal("daily_limit", { precision: 18, scale: 4 }), // null = no limit
  monthlyLimit: decimal("monthly_limit", { precision: 18, scale: 4 }),
  notifyPhone: varchar("notify_phone", { length: 64 }),
...
export const receipts = mysqlTable("receipts", {
  ...
  // Beneficiary info (المستفيد)
  beneficiaryName: varchar("beneficiary_name", { length: 255 }),
  beneficiaryPhone: varchar("beneficiary_phone", { length: 64 }),
  beneficiaryId: varchar("beneficiary_id", { length: 128 }),       // National ID or passport
