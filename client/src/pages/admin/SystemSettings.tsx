...
import { Settings, DollarSign, Building2, Info, Save, RefreshCw, Coins, MessageCircle, ArrowLeft } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <button
          onClick={() => setLocation("/admin/currencies")}
          className="flex items-center justify-between gap-3 rounded-xl border bg-white p-4 hover:shadow-md transition-shadow text-right"
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-semibold text-sm">العملات وأسعار الصرف</p>
              <p className="text-xs text-slate-500">إضافة/تعديل العملات المتاحة</p>
            </div>
          </div>
          <ArrowLeft className="w-4 h-4 text-slate-400" />
        </button>
        <button
          onClick={() => setLocation("/admin/settings/whatsapp")}
          className="flex items-center justify-between gap-3 rounded-xl border bg-white p-4 hover:shadow-md transition-shadow text-right"
        >
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-lg bg-green-50 text-green-600 flex items-center justify-center"><MessageCircle className="w-5 h-5" /></div>
            <div>
              <p className="font-semibold text-sm">إعدادات واتساب</p>
              <p className="text-xs text-slate-500">إشعارات تلقائية للعملاء</p>
            </div>
          </div>
          <ArrowLeft className="w-4 h-4 text-slate-400" />
        </button>
